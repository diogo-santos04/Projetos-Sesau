<div class="p-3" style="background-color:#D8AE7E">
    ...
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.modal-component', ['corPrimaria' => '#D8AE7E','corSecundaria' => '#F8C794','corFooter' => '#D8AE7E','title' => 'Unidade','icon' => 'fas fa-map-marker-alt icon','form' => 'admin.sesau.semraiva.unidade.form_table','modalId' => 'Unidadee','tamanho' => 'modal-fullscreen'])->html();
    ...
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.modal-component', ['corPrimaria' => '#D8AE7E','corSecundaria' => '#F8C794','corFooter' => '#D8AE7E','title' => 'Unidade','icon' => 'fas fa-map-marker-alt icon','form' => 'admin.sesau.semraiva.unidade.form_table','modalId' => 'Unidadee','tamanho' => 'modal-fullscreen']);
    $html = $response->html();
...
?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.modal-component', ['corPrimaria' => '#D8AE7E','corSecundaria' => '#F8C794','corFooter' => '#D8AE7E','title' => 'Distrito','icon' => 'fas fa-map-marker-alt icon','form' => 'admin.sesau.semraiva.distrito.distritoform','modalId' => 'Distrito','tamanho' => 'modal-fullscreen'])->html();
} elseif ($_instance->childHasBeenRendered(''.e(Str::random(5)).'')) {
    $componentId = $_instance->getRenderedChildComponentId(''.e(Str::random(5)).'');
    $componentTag = $_instance->getRenderedChildComponentTagName(''.e(Str::random(5)).'');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    ...
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.modal-component', ['corPrimaria' => '#D8AE7E','corSecundaria' => '#F8C794','corFooter' => '#D8AE7E','title' => 'Distrito','icon' => 'fas fa-map-marker-alt icon','form' => 'admin.sesau.semraiva.distrito.distritoform','modalId' => 'Distrito','tamanho' => 'modal-fullscreen']);
    $html = $response->html();
    $_instance->logRenderedChild(''.e(Str::random(5)).'', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.modal-component', ['corPrimaria' => '#D8AE7E','corSecundaria' => '#F8C794','corFooter' => '#D8AE7E','title' => 'Unidade','icon' => 'fas fa-map-marker-alt icon','form' => 'admin.sesau.semraiva.unidade.form_modal','modalId' => 'Unidade','tamanho' => 'modal-fullscreen'])->html();
} elseif ($_instance->childHasBeenRendered(''.e(Str::random(5)).'')) {
    $componentId = $_instance->getRenderedChildComponentId(''.e(Str::random(5)).'');
    $componentTag = $_instance->getRenderedChildComponentTagName(''.e(Str::random(5)).'');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    ...
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.modal-component', ['corPrimaria' => '#D8AE7E','corSecundaria' => '#F8C794','corFooter' => '#D8AE7E','title' => 'Unidade','icon' => 'fas fa-map-marker-alt icon','form' => 'admin.sesau.semraiva.unidade.form_modal','modalId' => 'Unidade','tamanho' => 'modal-fullscreen']);
    $html = $response->html();
    $_instance->logRenderedChild(''.e(Str::random(5)).'', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
        ...
        <?php endif; ?>
            ...
            <div class="card p-4 mb-4 ml-4">            
                <div class="row">
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-white','title' => 'App','text_color' => 'text-white','text' => 'teste texto','icon' => 'fas fa-mobile-alt icon','cor' => 'bg-primary','link' => 'https://semraiva.flutterflow.app/'])->html();
} elseif ($_instance->childHasBeenRendered(''.e(Str::random(5)).'')) {
    $componentId = $_instance->getRenderedChildComponentId(''.e(Str::random(5)).'');
    $componentTag = $_instance->getRenderedChildComponentTagName(''.e(Str::random(5)).'');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    ...
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-white','title' => 'App','text_color' => 'text-white','text' => 'teste texto','icon' => 'fas fa-mobile-alt icon','cor' => 'bg-primary','link' => 'https://semraiva.flutterflow.app/']);
    $html = $response->html();
    $_instance->logRenderedChild(''.e(Str::random(5)).'', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-white','title' => 'Site','text_color' => 'text-white','text' => 'teste texto','icon' => 'fas fa-globe icon','cor' => 'bg-success','link' => 'http://semraiva.by.dev.br/'])->html();
} elseif ($_instance->childHasBeenRendered(''.e(Str::random(5)).'')) {
    $componentId = $_instance->getRenderedChildComponentId(''.e(Str::random(5)).'');
    $componentTag = $_instance->getRenderedChildComponentTagName(''.e(Str::random(5)).'');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    ...
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-white','title' => 'Site','text_color' => 'text-white','text' => 'teste texto','icon' => 'fas fa-globe icon','cor' => 'bg-success','link' => 'http://semraiva.by.dev.br/']);
    $html = $response->html();
    $_instance->logRenderedChild(''.e(Str::random(5)).'', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-white','title' => 'Form','text_color' => 'text-white','text' => 'teste texto','icon' => 'fas fa-file-alt icon','cor' => 'bg-danger','link' => ''])->html();
} elseif ($_instance->childHasBeenRendered(''.e(Str::random(5)).'')) {
    $componentId = $_instance->getRenderedChildComponentId(''.e(Str::random(5)).'');
    $componentTag = $_instance->getRenderedChildComponentTagName(''.e(Str::random(5)).'');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    ...
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-white','title' => 'Form','text_color' => 'text-white','text' => 'teste texto','icon' => 'fas fa-file-alt icon','cor' => 'bg-danger','link' => '']);
    $html = $response->html();
    $_instance->logRenderedChild(''.e(Str::random(5)).'', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-dark','title' => 'Gestor','text_color' => 'text-dark','text' => 'teste texto','icon' => 'fas fa-cogs icon','cor' => 'bg-warning','link' => ''])->html();
} elseif ($_instance->childHasBeenRendered(''.e(Str::random(5)).'')) {
    $componentId = $_instance->getRenderedChildComponentId(''.e(Str::random(5)).'');
    $componentTag = $_instance->getRenderedChildComponentTagName(''.e(Str::random(5)).'');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    ...
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-dark','title' => 'Gestor','text_color' => 'text-dark','text' => 'teste texto','icon' => 'fas fa-cogs icon','cor' => 'bg-warning','link' => '']);
    $html = $response->html();
    $_instance->logRenderedChild(''.e(Str::random(5)).'', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-white','title' => 'Unidade','text_color' => 'text-white','text' => 'teste texto','icon' => 'fas fa-map-marker-alt icon','cor' => 'bg-info','link' => '','modalId' => 'Unidadee'])->html();
} elseif ($_instance->childHasBeenRendered(''.e(Str::random(5)).'')) {
    $componentId = $_instance->getRenderedChildComponentId(''.e(Str::random(5)).'');
    $componentTag = $_instance->getRenderedChildComponentTagName(''.e(Str::random(5)).'');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    ...
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-white','title' => 'Unidade','text_color' => 'text-white','text' => 'teste texto','icon' => 'fas fa-map-marker-alt icon','cor' => 'bg-info','link' => '','modalId' => 'Unidadee']);
    $html = $response->html();
    $_instance->logRenderedChild(''.e(Str::random(5)).'', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-white','title' => 'Distrito','text_color' => 'text-white','text' => 'teste texto','icon' => 'fas fa-map-marker-alt icon','cor' => 'bg-info','link' => '','modalId' => 'Distrito'])->html();
} elseif ($_instance->childHasBeenRendered(''.e(Str::random(5)).'')) {
    $componentId = $_instance->getRenderedChildComponentId(''.e(Str::random(5)).'');
    $componentTag = $_instance->getRenderedChildComponentTagName(''.e(Str::random(5)).'');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    ...
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.card-component', ['textColor' => 'text-white','title' => 'Distrito','text_color' => 'text-white','text' => 'teste texto','icon' => 'fas fa-map-marker-alt icon','cor' => 'bg-info','link' => '','modalId' => 'Distrito']);
    $html = $response->html();
    $_instance->logRenderedChild(''.e(Str::random(5)).'', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>                   
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.crud.crud-table-component', ['formType' => 'modal','modal' => 'Unidade','title' => 'Unidade','model' => 'App\Models\Admin\Sesau\Semraiva\Unidade','form' => 'admin.sesau.semraiva.unidade.form_modal'])->html();
} elseif ($_instance->childHasBeenRendered(''.e(Str::random(5)).'')) {
    $componentId = $_instance->getRenderedChildComponentId(''.e(Str::random(5)).'');
    $componentTag = $_instance->getRenderedChildComponentTagName(''.e(Str::random(5)).'');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    ...
    $response = \Livewire\Livewire::mount('admin.crud.crud-table-component', ['formType' => 'modal','modal' => 'Unidade','title' => 'Unidade','model' => 'App\Models\Admin\Sesau\Semraiva\Unidade','form' => 'admin.sesau.semraiva.unidade.form_modal']);
    $html = $response->html();
    $_instance->logRenderedChild(''.e(Str::random(5)).'', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        ...
        '
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.dado-residencia-component')->html();
} elseif ($_instance->childHasBeenRendered('l3628072194-10')) {
    $componentId = $_instance->getRenderedChildComponentId('l3628072194-10');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3628072194-10');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3628072194-10');
} else {
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.dado-residencia-component');
    $html = $response->html();
    $_instance->logRenderedChild('l3628072194-10', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="card p-4 mb-4">
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="form-floating mb-4 col-4">
                            <select wire:model="data.arranhadura" class="form-select" <?php echo e($select == "2" || $select == "9"  ? '' : 'disabled'); ?> >
                                <option value="">Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>
                                <option value="9">Ignorado</option>
                        ...
                        <div class="form-floating mb-4 col-2">
                            <select wire:model="data.lambedura" class="form-select" <?php echo e($select == "2" || $select == "9"  ? '' : 'disabled'); ?>>
                                <option value="">Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>
                                <option value="9">Ignorado</option>
                        ...
                        <div class="form-floating mb-4 col-2">
                            <select wire:model="data.mordedura" class="form-select" <?php echo e($select == "2" || $select == "9"  ? '' : 'disabled'); ?>>
                                <option value="">Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>
                                <option value="9">Ignorado</option>
                        ...
                        <div class="form-floating mb-4 col-2">
                            <select wire:model="data.outro" class="form-select" <?php echo e($select == "2" || $select == "9"  ? '' : 'disabled'); ?>>
                                <option value="">Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>
                                <option value="9">Ignorado</option>
                        ...
                        <div class="form-floating mb-4 col-4">
                            <input type="text" wire:model="data.outra_especie" <?php echo e($outra == "7"  ? '' : 'disabled readonly'); ?> class="form-control" placeholder="40.1 - Outra">
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.tratamento-atual-component')->html();
} elseif ($_instance->childHasBeenRendered('l3628072194-11')) {
    $componentId = $_instance->getRenderedChildComponentId('l3628072194-11');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3628072194-11');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3628072194-11');
} else {
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.tratamento-atual-component');
    $html = $response->html();
    $_instance->logRenderedChild('l3628072194-11', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.investigador-component')->html();
} elseif ($_instance->childHasBeenRendered('l3628072194-12')) {
    $componentId = $_instance->getRenderedChildComponentId('l3628072194-12');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3628072194-12');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3628072194-12');
} else {
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.investigador-component');
    $html = $response->html();
    $_instance->logRenderedChild('l3628072194-12', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

    </div>
</div><?php /**PATH D:\Projetos\sesau1\resources\views/livewire/admin/sesau/semraiva/ficha-component.blade.php ENDPATH**/ ?>