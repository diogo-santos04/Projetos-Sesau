<div class="card p-4 mb-4">
    ...
    <?php if($openForm): ?>
        <form wire:submit.prevent="<?php echo e($unidadeId ? 'update' : 'store'); ?>">
            <div class="row">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card p-4 mb-4">
        <div>
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.sesau.semraiva.semraiva-table-component', ['model' => 'App\Models\Admin\Sesau\Semraiva\Unidade','title' => 'Unidade'])->html();
    ...
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.semraiva-table-component', ['model' => 'App\Models\Admin\Sesau\Semraiva\Unidade','title' => 'Unidade']);
    $html = $response->html();
...
<?php /**PATH C:\katiane\sesau\resources\views/livewire/admin/sesau/semraiva/unidade-component.blade.php ENDPATH**/ ?>