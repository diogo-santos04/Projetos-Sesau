<div wire:ignore.self class="dropdown d-grid gap-2">
    <button wire:ignore.self type="button"class="btn btn-lg btn-<?php echo e($color); ?> dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"data-bs-auto-close="outside">
        <?php echo e($title); ?>          
    </button>
...
<?php /**PATH D:\Projetos\sesau1\resources\views/livewire/admin/sesau/juridico/dropdown-component.blade.php ENDPATH**/ ?>