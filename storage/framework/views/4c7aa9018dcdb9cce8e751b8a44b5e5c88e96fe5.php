...
} elseif ($_instance->childHasBeenRendered('l159738904-10')) {
    $componentId = $_instance->getRenderedChildComponentId('l159738904-10');
    $componentTag = $_instance->getRenderedChildComponentTagName('l159738904-10');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l159738904-10');
} else {
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.dado-residencia-component');
    $html = $response->html();
    $_instance->logRenderedChild('l159738904-10', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="card p-4 mb-4">
...
} elseif ($_instance->childHasBeenRendered('l159738904-11')) {
    $componentId = $_instance->getRenderedChildComponentId('l159738904-11');
    $componentTag = $_instance->getRenderedChildComponentTagName('l159738904-11');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l159738904-11');
} else {
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.tratamento-atual-component');
    $html = $response->html();
    $_instance->logRenderedChild('l159738904-11', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l159738904-12')) {
    $componentId = $_instance->getRenderedChildComponentId('l159738904-12');
    $componentTag = $_instance->getRenderedChildComponentTagName('l159738904-12');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l159738904-12');
} else {
    $response = \Livewire\Livewire::mount('admin.sesau.semraiva.investigador-component');
    $html = $response->html();
    $_instance->logRenderedChild('l159738904-12', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

    </div>
</div><?php /**PATH C:\katiane\sesau\resources\views/livewire/admin/sesau/semraiva/ficha-component.blade.php ENDPATH**/ ?>