...
class CreateSindicanciaPessoasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('juridico.sindicancia_pessoas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('juridico.sindicancia_pessoas');
    }
}
